namespace RSAcli
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //RSAEngine.GenerateKyes(out byte[] privateKey, out byte[] publicKey);
            ...
            //byte[] encryptedRsaParams = rsaEngine.EncryptData(Encoding.UTF8.GetBytes(original));
            byte[] encryptedRsaParams = rsaEngine.EncryptData(new BigInteger(2).ToByteArray());
            Console.Out.WriteLine("encryptedRsaParams = {0}", new BigInteger(encryptedRsaParams));
